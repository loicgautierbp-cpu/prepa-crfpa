      ...
      <div className="w-full max-w-[440px] bg-white rounded-xl border border-slate-200 shadow-sm p-8 sm:p-10 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-xs text-[#0d6560] hover:text-[#5a1028] font-semibold hover:underline"
              >
                Oublié ?
              </button>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 px-6 bg-[#0d6560] hover:bg-[#064e4a] hover:scale-[1.02] transition-all text-white text-sm font-semibold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
          >
            {loading ? (
              <>
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link href="/inscription" className="text-[#0d6560] hover:text-[#5a1028] font-bold hover:underline">
