      ...
      <section className="bg-[#fef2f2] pt-28 pb-10 md:pt-36 md:pb-14 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 style={{ fontFamily: 'var(--font-display)' }} className="text-4xl sm:text-5xl font-bold text-gray-900 leading-[1.1] tracking-tight mb-4">
            Conditions G&eacute;n&eacute;rales de{' '}<span className="text-[#991b1b]">Vente</span>
          </h1>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 md:p-12 space-y-10">
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#991b1b]"></span>Article 2 &ndash; Services</h2>
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#991b1b]"></span>Article 3 &ndash; Tarifs et paiement</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
                <p>Tarifs en euros TTC, sans engagement. Paiement mensuel par carte bancaire.</p>
              </div>
            </article>
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#991b1b]"></span>Article 4 &ndash; R&eacute;tractation</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
                <p>D&eacute;lai de 14 jours (art. L221-18 Code de la consommation). Contact : <a href="mailto:support@prepa-crfpa.fr" className="text-[#991b1b] hover:underline">support@prepa-crfpa.fr</a></p>
              </div>
            </article>
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#991b1b]"></span>Article 5 &ndash; R&eacute;siliation</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
