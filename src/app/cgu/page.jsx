      ...
      <section className="bg-[#eceef1] pt-28 pb-10 md:pt-36 md:pb-14 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 style={{ fontFamily: 'var(--font-display)' }} className="text-4xl sm:text-5xl font-bold text-gray-900 leading-[1.1] tracking-tight mb-4">
            Conditions G&eacute;n&eacute;rales d&rsquo;<span className="text-[#7b1636]">Utilisation</span>
          </h1>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 md:p-12 space-y-10">
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#7b1636]"></span>Article 2 &ndash; Acceptation</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#7b1636]"></span>Article 3 &ndash; Propri&eacute;t&eacute; intellectuelle</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#7b1636]"></span>Article 4 &ndash; Contenus p&eacute;dagogiques</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
                <p>Les contenus sont fournis &agrave; titre informatif. Ils ne se substituent pas &agrave; l&rsquo;enseignement des IEJ.</p>
              </div>
            </article>
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-[#7b1636]"></span>Article 5 &ndash; Donn&eacute;es personnelles</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
                <p>LP Labs traite les donn&eacute;es conform&eacute;ment au RGPD. Contact : <a href="mailto:support@prepa-crfpa.fr" className="text-[#7b1636] hover:underline">support@prepa-crfpa.fr</a></p>
              </div>
            </article>
            <article>
