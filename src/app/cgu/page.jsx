      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#faf6f2] rounded-2xl border border-gray-100 shadow-sm p-8 md:p-12 space-y-10">
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-primary-500"></span>Article 2 &ndash; Acceptation</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-primary-500"></span>Article 3 &ndash; Propri&eacute;t&eacute; intellectuelle</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
            ...
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-primary-500"></span>Article 4 &ndash; Contenus p&eacute;dagogiques</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
                <p>Les contenus sont fournis &agrave; titre informatif. Ils ne se substituent pas &agrave; l&rsquo;enseignement des IEJ.</p>
              </div>
            </article>
            <article>
              <h2 style={{ fontFamily: 'var(--font-display)' }} className="text-xl font-black text-gray-900 mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-primary-500"></span>Article 5 &ndash; Donn&eacute;es personnelles</h2>
              <div className="text-sm text-gray-600 leading-relaxed space-y-2">
