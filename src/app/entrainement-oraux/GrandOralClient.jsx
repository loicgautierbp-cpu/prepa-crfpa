      ...
      <div className={embedded ? 'max-w-4xl mx-auto' : 'max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12'}>
        ...
        {step !== 'type' && (
          <div className="flex items-center justify-between gap-3 mb-6">
            ...
            {step === 'exercise' && (sujet || juryQuestions) && (
              <button
                type="button"
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {EXERCISE_TYPES.map((type) => {
                ...
                <button
                  ...
                  className={`lift group relative text-left bg-white rounded-2xl border border-slate-200 border-t-4 ${type.color.border} p-6 flex flex-col transition-all hover:shadow-xl hover:border-slate-300 disabled:cursor-wait ${isGenerating && !isLoading ? 'opacity-50 pointer-events-none' : ''}`}
                >
                  {/* Badge */}
