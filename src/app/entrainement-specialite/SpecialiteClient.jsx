        ...
        {step === 'exercise' && (
          <div className="space-y-6">
            ...
            {!subject && isGenerating && (
              <GenerationLoader
                title={selectedType === 'cas-pratique' ? 'Génération de votre cas pratique' : 'Génération de votre sujet'}
                subtitle={`${selectedSpecialite?.name} · ${selectedType === 'cas-pratique' ? 'Cas pratique' : selectedType === 'dissertation' ? 'Dissertation' : 'Consultation'}`}
                accent="#b91c1c"
              />
            )}
