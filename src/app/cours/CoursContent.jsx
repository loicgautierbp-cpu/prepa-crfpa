  ...
  return (
    <>
      ...
      <div className="fixed top-[64px] left-0 right-0 z-40 h-1 bg-gray-100">
        <div
          className="h-full bg-[#a01545] rounded-r-full transition-[width] duration-300"
          style={{ width: `${scrollProgress}%` }}
        />
      </div>

      {/* ====== HERO ====== */}
      <section className="relative pt-4 pb-5 md:pt-6 md:pb-6 overflow-hidden" style={{ background: 'linear-gradient(135deg, #6b0d25 0%, #a01545 40%, #8f173b 70%, #ab1842 100%)' }}>
            ...
            <aside className="hidden lg:block w-60 shrink-0">
              <div className="sticky top-24">
                      ...
                      return (
                        <a
                          ...
                          className={`group flex items-center gap-3 pl-4 py-2 text-sm border-l-2 rounded-r-lg transition-all hover:translate-x-1 ${
                            isActive
                              ? 'border-l-[#a01545] text-[#a01545] font-bold'
                        ...
                        >
                          <span className={`w-5 h-5 rounded-md flex items-center justify-center text-[10px] font-bold shrink-0 transition-colors ${
                            isActive ? 'bg-slate-100 text-[#a01545]' : 'bg-gray-100 group-hover:bg-gray-200 text-gray-400 group-hover:text-gray-600'
                          }`}>
                            {i + 1}
                          </span>
                ...
                <div className="mt-4">
                  <Link
                    href="/fiches"
                    className="flex items-center gap-2 px-4 py-2.5 bg-white rounded-xl border border-gray-200 text-xs font-medium text-gray-500 hover:text-[#a01545] hover:border-slate-300 transition-colors shadow-sm hover:shadow-md"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
                    </svg>
            ...
            <main className="flex-1 min-w-0">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row gap-3 justify-between">
                  <Link
                    href="/fiches"
                    className="inline-flex items-center gap-2 px-5 py-3 bg-white text-gray-700 font-bold rounded-xl border-2 border-gray-200 hover:border-slate-300 hover:text-[#a01545] transition-all text-sm shadow-sm"
                  >
