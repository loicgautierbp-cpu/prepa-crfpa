  ...
  return (
    <div className="bg-[#f0fdfa]">
      ...
      <section className="relative pt-20 pb-16 md:pt-28 md:pb-24 overflow-hidden min-h-[85vh] flex items-center bg-gradient-to-b from-white via-[#f5fdfb] to-[#e6f7f4]">
        {/* Decorative legal icons with animations */}
        {/* Balance de justice - haut centre */}
        <svg className="hidden md:block absolute top-10 left-[42%] w-20 h-20 text-[#0f766e]/25 animate-[float_5s_ease-in-out_infinite]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52 2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 0 1-2.031.352 5.988 5.988 0 0 1-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971Zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0 2.62 10.726c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 0 1-2.031.352 5.989 5.989 0 0 1-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971Z" />
        </svg>
        {/* Marteau du juge (gavel) - gauche haut */}
        <svg className="hidden md:block absolute top-16 left-[4%] w-24 h-24 text-[#0f766e]/18 animate-[float_9s_ease-in-out_infinite_2s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
        </svg>
        {/* Tribunal / Palais de justice - gauche milieu */}
        <svg className="hidden md:block absolute top-[50%] left-[3%] w-28 h-28 text-[#0f766e]/15 animate-[float_7s_ease-in-out_infinite_4s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.7">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
        </svg>
        {/* Code juridique (livre ouvert) - bas gauche */}
        <svg className="hidden md:block absolute bottom-20 left-[10%] w-20 h-20 text-[#0f766e]/20 animate-[float_11s_ease-in-out_infinite_1s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25"/>
        </svg>
        {/* Bouclier (protection des droits) - haut droite */}
        <svg className="hidden md:block absolute top-12 right-[18%] w-16 h-16 text-[#0f766e]/20 animate-[float_8s_ease-in-out_infinite_6s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
        </svg>
        {/* Paragraphe § (article de loi) - droite milieu */}
        <svg className="hidden lg:block absolute top-[45%] right-[4%] w-18 h-18 text-[#0f766e]/22 animate-[float_7s_ease-in-out_infinite_7s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
        </svg>
        {/* Diplôme / Certificat - droite bas */}
        <svg className="hidden md:block absolute bottom-[25%] right-[5%] w-14 h-14 text-[#0f766e]/18 animate-[float_10s_ease-in-out_infinite_5s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
        </svg>
        {/* Cadenas (sécurité juridique) - bas centre droite */}
        <svg className="hidden md:block absolute bottom-10 right-[30%] w-12 h-12 text-[#0f766e]/18 animate-[float_7s_ease-in-out_infinite_7s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
        </svg>
        {/* Stylo plume (rédaction juridique) - haut gauche secondaire */}
        <svg className="hidden lg:block absolute top-[30%] left-[18%] w-12 h-12 text-[#0f766e]/15 animate-[float_12s_ease-in-out_infinite_8s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8">
      ...
      <section className="bg-[#042f2c] py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
            {[
              { value: 'Illimités', label: 'Exercices corrigés par IA', svg: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" /></svg> },
              { value: '14', label: 'Matières du programme', svg: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" /></svg> },
              { value: 'x2', label: 'Épreuves orales couvertes', svg: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 0 1-3-3V4.5a3 3 0 1 1 6 0v8.25a3 3 0 0 1-3 3Z" /></svg> },
      ...
      <section className="py-20 md:py-24 relative overflow-hidden">
        ...
        <svg className="hidden md:block absolute bottom-20 right-[6%] w-20 h-20 text-[#0f766e]/15 animate-[float_7s_ease-in-out_infinite_4s]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.7">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25"/>
        </svg>
        <svg className="hidden lg:block absolute top-[40%] right-[3%] w-12 h-12 text-amber-400/30 animate-[float_11s_ease-in-out_infinite_1s]" fill="currentColor" viewBox="0 0 24 24">
