...
export default function HomePage() {
  return (
    <div className="bg-[#fef2f2]">
      ...
      {/* ========== HERO ========== */}
      <section className="relative pt-12 pb-12 md:pt-16 md:pb-20 overflow-hidden bg-gradient-to-br from-white via-[#fef2f2] to-[#fee2e2]">
