    ...
    <div className="min-h-screen bg-[#eceef1] flex items-center justify-center px-4 py-24 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] bg-white rounded-xl border border-slate-200 shadow-sm p-8 sm:p-10 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading} className="w-full py-3.5 px-6 bg-[#a01545] hover:bg-[#7b1030] hover:scale-[1.02] transition-all text-white text-sm font-semibold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2">
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          Déjà un compte ?{' '}
          <Link href="/connexion" className="text-[#a01545] hover:text-[#5a1028] font-bold hover:underline">Se connecter</Link>
        </p>
      </div>
    </div>
  );
