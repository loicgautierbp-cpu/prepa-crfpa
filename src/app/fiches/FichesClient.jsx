    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-[#4c1d95] text-xs font-bold group-hover:gap-2.5 transition-all">
            Lire la fiche
...
function FicheModal({ fiche, onClose, premiumUser, user, onLoginRequired, onUpgradeRequired }) {
  ...
  const handleDownloadPDF = useCallback(async () => {
    ...
    try {
      ...
      const pdfHexColors = {
        indigo:  { bg: '#f5f3ff', accent: '#c92150', accentDark: '#8f173b', accentDeep: '#2e1065', badge: '#fce7ea', badgeText: '#8f173b', light: '#facdd4', lighter: '#fce7ea' },
        primary: { bg: '#f5f3ff', accent: '#c92150', accentDark: '#8f173b', accentDeep: '#2e1065', badge: '#fce7ea', badgeText: '#8f173b', light: '#facdd4', lighter: '#fce7ea' },
              ...
              <div className="flex flex-wrap items-center justify-center gap-5 sm:gap-6">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 bg-slate-100 rounded-xl flex items-center justify-center">
                    <svg className="w-5 h-5 text-[#4c1d95]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
