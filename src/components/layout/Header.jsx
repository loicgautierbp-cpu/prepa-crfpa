      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-10 h-10 bg-[#5b21b6] rounded-xl flex items-center justify-center">
            ...
            <div>
              <span style={{ fontFamily: 'var(--font-display)' }} className="text-xl text-slate-900 font-bold">Prépa <span className="text-[#5b21b6]">CRFPA</span></span>
              ...
              <>
                {user ? (
                  <div className="hidden sm:flex items-center gap-3">
                    ...
                    <Link
                      href="/dashboard"
                      className="px-4 py-2 bg-[#4c1d95] text-white text-sm font-semibold rounded-xl hover:bg-[#3b0764] transition-colors"
                    >
                      Mon tableau de bord
                    </Link>
                    <button
                  ...
                  <div className="hidden sm:flex items-center gap-2">
                    ...
                    <Link href="/inscription" className="px-5 py-2 bg-[#5b21b6] text-white text-sm font-semibold rounded-xl hover:bg-[#4c1d95] transition-colors">
                      Inscription
                    </Link>
                  </div>
                )}
          ...
          {navLinks.map(link => (
            <Link
              ...
              className={`block py-3 text-sm font-medium ${
                isActive(link.href) ? 'text-[#5b21b6] font-semibold' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              {link.label}
            </Link>
            ...
            <>
              {user ? (
                <>
                  ...
                  <Link href="/dashboard" onClick={() => setMenuOpen(false)} className="block mt-1 px-5 py-2.5 bg-[#4c1d95] text-white text-sm font-semibold rounded-xl text-center hover:bg-[#3b0764] transition-colors">
                    Mon tableau de bord
                  </Link>
                ...
                <>
                  ...
                  <Link href="/inscription" onClick={() => setMenuOpen(false)} className="block mt-2 px-5 py-2.5 bg-[#4c1d95] text-white text-sm font-semibold rounded-xl text-center hover:bg-[#3b0764] transition-colors">
                    Inscription
                  </Link>
                </>
              )}
