      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <div>
              <span style={{ fontFamily: 'var(--font-display)' }} className="text-xl text-slate-900 font-bold">Prépa <span className="text-[#b91c1c]">CRFPA</span></span>
              ...
              <>
                {user ? (
                  <div className="hidden sm:flex items-center gap-3">
                    ...
                    <Link
                      href="/dashboard"
                      className="px-4 py-2 bg-[#991b1b] text-white text-sm font-semibold rounded-xl hover:bg-[#7f1d1d] transition-colors"
                    >
                      Mon tableau de bord
                    </Link>
                    <button
                  ...
                  <div className="hidden sm:flex items-center gap-2">
                    ...
                    <Link href="/inscription" className="px-5 py-2 bg-[#b91c1c] text-white text-sm font-semibold rounded-xl hover:bg-[#991b1b] transition-colors">
                      Inscription
                    </Link>
                  </div>
                )}
          ...
          {navLinks.map(link => (
            <Link
              ...
              className={`block py-3 text-sm font-medium ${
                isActive(link.href) ? 'text-[#b91c1c] font-semibold' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              {link.label}
            </Link>
            ...
            <>
              {user ? (
                <>
                  ...
                  <Link href="/dashboard" onClick={() => setMenuOpen(false)} className="block mt-1 px-5 py-2.5 bg-[#991b1b] text-white text-sm font-semibold rounded-xl text-center hover:bg-[#7f1d1d] transition-colors">
                    Mon tableau de bord
                  </Link>
                ...
                <>
                  ...
                  <Link href="/inscription" onClick={() => setMenuOpen(false)} className="block mt-2 px-5 py-2.5 bg-[#991b1b] text-white text-sm font-semibold rounded-xl text-center hover:bg-[#7f1d1d] transition-colors">
                    Inscription
                  </Link>
                </>
              )}
